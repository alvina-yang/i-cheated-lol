      ...
      {loadingStates.map((loadingState, index) => {
        ...
        return (
          ...
          >
            <div>
              {index > value && (
                <CheckIcon className="text-zinc-300 dark:text-zinc-300" />
              )}
              {index <= value && (
                <CheckFilled
                  className={cn(
                    ...
                    value === index &&
                      "text-purple-400 dark:text-purple-400 opacity-100"
                  )}
                />
              )}
            </div>
            <span
              className={cn(
                "text-zinc-300 dark:text-zinc-300",
                value === index && "text-purple-400 dark:text-purple-400 opacity-100"
              )}
            >
              {loadingState.text}
            </span>
